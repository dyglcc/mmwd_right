		...
		if (!TextUtils.isEmpty(positiveButtonText)) {
			builder.setPositiveButton(positiveButtonText, new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					SimpleDialogBuilder builder = (SimpleDialogBuilder) getArguments().getSerializable(BaseDialogBuilder.BASE_BUILDER);
					if (builder.getPositiveClick() != null) {
						builder.getPositiveClick().onClick(view);
					}
					if (listener != null) {
