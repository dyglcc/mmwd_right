...
//        AdhocTracker.initalize(this);
        ...
        Apptimize.setup(this, "BVwaB2ycd2M5yke8bfhGvMTxUDcbggY");
//        AdhocTracker.enableDebue(true);

//        try {
//            logTest.getInstance().enableDebug(this);
//        } catch (NoSuchFieldException e) {
//            e.printStackTrace();
//        } catch (IllegalAccessException e) {
//            e.printStackTrace();
//        }
//        logTest.getInstance().createLogCollector(this);
