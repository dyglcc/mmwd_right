...
//		this.startActivity(intent);
    ...
    void shareMoments() {
        ShareUtils.momentsGoodItem(getGoodsBean(wrapper), this, "android_mmwdapp_postpreviewshare_wctimeline");
    ...
    void shareWX() {
        ...
        ShareUtils.friendGoodItem(getGoodsBean(wrapper), this, "android_mmwdapp_postpreviewshare_wcfriend");
    }
    ...
    void shareOneKey() {
        ...
        intent.putExtra(ConstValue.gaSrcfrom, "android_mmwdapp_postpreviewshare_");
