...
public class CommodityItemView extends LinearLayout {
    ...
    @ViewById
    ImageView iv_icon, iv_promotation, iv_indicator, iv_menu_top, iv_top;
    @ViewById
    TextView tv_name, tv_time, tv_price, tv_stock, tv_salesvolume;
    @ViewById
    TextView tv_menu_promotation, tv_menu_share, tv_menu_edit, tv_menu_top, tv_menu_preview, tv_menu_offshelf;
    @ViewById
    ...
    @Bean
    CommodityDataController controller;
