...
public final class OkApacheClient implements HttpClient {
  ...
  @Override public HttpResponse execute(HttpHost host, HttpRequest request, HttpContext context)
      throws IOException {
    return execute(host, request, context, "");
  }
  
  public HttpResponse execute(HttpUriRequest request, Object tag) throws IOException {
	  return execute(null, request, null, tag);
  }
  
  public HttpResponse execute(HttpHost host, HttpRequest request, HttpContext context, Object tag)
		  throws IOException {
	  Request okRequest = transformRequest(request, tag);
